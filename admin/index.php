                        ...
                        <div class="row mbl">
                            <div class="col-lg-12">
                                            <div class="col-md-12">
                                                ...
                                                <canvas height="300" width="992" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 992px; height: 300px;" class="flot-base">
                                                </canvas>
                          ...
                          <?php
                            if($EXISTE_REGIONAL){
                                foreach ($lista_regionais as $regional) {
                                    ?>
                                    <a href="regional.php?id_regional_selec=<?php echo $regional->idRegional;?>&opcao=admin"
                                       class="list-group-item"><?php echo $regional->nome;?></a>
                                    <?php
                                }
                            }else{
                                ?>
                                <a>Não possui regional cadastrada!</a>
                                <?php
                            }
                          ?>
                        </div>
