...
if(!empty($escolasRegional) || $escolasRegional == -1) {
  ...
  <script type="text/javascript">
      ...
      function drawChart() {
          var data = google.visualization.arrayToDataTable([
              ['Bimestre', 'Pré-Silábico', 'Silábico', 'Silábico-Alfabético','Alfabético','Ortográfico'],
